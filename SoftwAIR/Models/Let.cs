...
namespace SoftwAIR.Models
{
    public class Let
    {
        ...
        public Let(int ID, int kodZaStatusLeta, Lokacija polazak, Lokacija dolazak, Avion avion, DateTime vrijemePolaska, DateTime vrijemeDolaska, Double osnovnaCijena, Boolean naPopustuZaLoyalty, String statusLeta)
        {
            this.ID = ID;
        ...
        public void promjeniStatus(String status) 
        {
        //TODO
        }
